...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxa61eed0f3b970aa7',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '34d8bee138498f7750ad95fdf28ea035',
  ...
  USERS: [Lovo1zZ
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2002', date: '10-03',
        },
        {
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2017-10-03' },
        // 结婚纪念日
        { keyword: 'marry_day', date: '2022-10-03' },
        // 退伍日
        { keyword: 'ex_day', date: '2022-07-03' }
      ],
      // 课程表相关配置
